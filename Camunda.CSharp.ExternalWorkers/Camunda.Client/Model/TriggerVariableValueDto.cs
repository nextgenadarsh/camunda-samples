...
namespace Camunda.Client.Model
{
        ...
        public partial class TriggerVariableValueDto :  IEquatable<TriggerVariableValueDto>, IValidatableObject
    {
        ...
        public TriggerVariableValueDto(Object value = default(Object), string type = default(string), Dictionary<string, Object> valueInfo = default(Dictionary<string, Object>))
        {
            this.Value = value;
            this.Type = type;
