...
namespace Camunda.Client.Model
{
        ...
        public partial class MultiFormAttachmentDto :  IEquatable<MultiFormAttachmentDto>, IValidatableObject
    {
        ...
        public MultiFormAttachmentDto(string attachmentName = default(string), string attachmentDescription = default(string), string attachmentType = default(string), string url = default(string), byte[] content = default(byte[]))
        {
