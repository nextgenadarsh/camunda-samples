...
namespace Camunda.Client.Model
{
        ...
        public partial class ExternalTaskBpmnError :  IEquatable<ExternalTaskBpmnError>, IValidatableObject
    {
        ...
        public ExternalTaskBpmnError(string errorCode = default(string), string errorMessage = default(string), Dictionary<string, VariableValueDto> variables = default(Dictionary<string, VariableValueDto>))
        {
