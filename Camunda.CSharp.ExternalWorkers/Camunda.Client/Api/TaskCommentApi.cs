...
namespace Camunda.Client.Api
{
        ...
        public interface ITaskCommentApi : IApiAccessor
    {
        ...
        /// <param name="body">**Note:** Only the &#x60;message&#x60; property will be used. Every other property passed to this endpoint will be ignored. (optional)</param>
        /// <returns>CommentDto</returns>
        CommentDto CreateComment (string id, CommentDto body = null);
        ...
        ApiResponse<CommentDto> CreateCommentWithHttpInfo (string id, CommentDto body = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CommentDto> CreateCommentAsync (string id, CommentDto body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<CommentDto>> CreateCommentAsyncWithHttpInfo (string id, CommentDto body = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        public partial class TaskCommentApi : ITaskCommentApi
    {
        ...
        /// <returns></returns>
        public TaskCommentApi(Camunda.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body">**Note:** Only the &#x60;message&#x60; property will be used. Every other property passed to this endpoint will be ignored. (optional)</param>
        /// <returns>CommentDto</returns>
        public CommentDto CreateComment (string id, CommentDto body = null)
        {
             ApiResponse<CommentDto> localVarResponse = CreateCommentWithHttpInfo(id, body);
        ...
        /// <param name="body">**Note:** Only the &#x60;message&#x60; property will be used. Every other property passed to this endpoint will be ignored. (optional)</param>
        /// <returns>ApiResponse of CommentDto</returns>
        public ApiResponse< CommentDto > CreateCommentWithHttpInfo (string id, CommentDto body = null)
        {
        ...
        /// <param name="body">**Note:** Only the &#x60;message&#x60; property will be used. Every other property passed to this endpoint will be ignored. (optional)</param>
        /// <returns>Task of CommentDto</returns>
        public async System.Threading.Tasks.Task<CommentDto> CreateCommentAsync (string id, CommentDto body = null)
        {
             ApiResponse<CommentDto> localVarResponse = await CreateCommentAsyncWithHttpInfo(id, body);
             return localVarResponse.Data;
        ...
        /// <param name="body">**Note:** Only the &#x60;message&#x60; property will be used. Every other property passed to this endpoint will be ignored. (optional)</param>
        /// <returns>Task of ApiResponse (CommentDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CommentDto>> CreateCommentAsyncWithHttpInfo (string id, CommentDto body = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling TaskCommentApi->CreateComment");
