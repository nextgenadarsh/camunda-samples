...
namespace Camunda.Client.Test
{
    ...
    public class TaskAttachmentApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' TaskAttachmentApi
            //Assert.IsInstanceOfType(typeof(TaskAttachmentApi), instance, "instance is a TaskAttachmentApi");
        }
        ...
        public void AddAttachmentTest()
        {
            ...
            //Assert.IsInstanceOf<AttachmentDto> (response, "response is AttachmentDto");
        }
        /// <summary>
        ...
        public void GetAttachmentsTest()
        {
            ...
            //Assert.IsInstanceOf<List<AttachmentDto>> (response, "response is List<AttachmentDto>");
        }
    }
