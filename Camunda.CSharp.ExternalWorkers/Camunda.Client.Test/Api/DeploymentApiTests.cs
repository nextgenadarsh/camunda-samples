...
namespace Camunda.Client.Test
{
    ...
    public class DeploymentApiTests
    {
        ...
        public void CreateDeploymentTest()
        {
            ...
            //Assert.IsInstanceOf<DeploymentWithDefinitionsDto> (response, "response is DeploymentWithDefinitionsDto");
        }
        /// <summary>
        ...
        public void GetDeploymentTest()
        {
            ...
            //Assert.IsInstanceOf<List<DeploymentDto>> (response, "response is List<DeploymentDto>");
        }
        /// <summary>
        ...
        public void GetDeploymentResourceTest()
        {
            ...
            //Assert.IsInstanceOf<DeploymentResourceDto> (response, "response is DeploymentResourceDto");
        }
        /// <summary>
        ...
        public void GetDeploymentResourcesTest()
        {
            ...
            //Assert.IsInstanceOf<List<DeploymentResourceDto>> (response, "response is List<DeploymentResourceDto>");
        }
        /// <summary>
        /// Test GetDeployments
        /// </summary>
        ...
        public void RedeployTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //RedeploymentDto body = null;
            //var response = instance.Redeploy(id, body);
            //Assert.IsInstanceOf<DeploymentWithDefinitionsDto> (response, "response is DeploymentWithDefinitionsDto");
        }
    }
