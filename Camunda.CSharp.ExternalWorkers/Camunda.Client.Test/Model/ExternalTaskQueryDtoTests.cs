...
namespace Camunda.Client.Test
{
    ...
    public class ExternalTaskQueryDtoTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" ExternalTaskQueryDto
            //Assert.IsInstanceOfType<ExternalTaskQueryDto> (instance, "variable 'instance' is a ExternalTaskQueryDto");
        }
